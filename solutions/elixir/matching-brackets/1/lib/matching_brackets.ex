defmodule MatchingBrackets do
  ...
  defp do_brackets_match?(<<open_bracket::bytes-size(1)>> <> rest, open_brackets)
       when open_bracket == "[" or open_bracket == "{" or open_bracket == "(" do
    do_brackets_match?(rest, [open_bracket | open_brackets])
  end

  defp do_brackets_match?(<<close_bracket::bytes-size(1)>> <> rest, [])
       when close_bracket == "]" or close_bracket == "}" or close_bracket == ")" do
    false
  end
